    ...
    <div class="modal fade" id="editInfo" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
	    <div class="modal-content">
                    ...
                    <?php if(isset($report)){
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input required type="text" name="surname" value="<?php echo ucwords($data['surname']) ?>" id="surname" placeholder="surname" class="form-control">
                                <p style="color:red;" id="surname_error"></p>

                                <input required type="text" name="phone" value="<?php echo ucwords($data['phone']) ?>"  id="phone"  placeholder="phone number" class="form-control">
                                ...
                                <select required name="country" id="country"  class="form-control"> 
                                    ...
                                    <input required type="text" name="city" value="<?php echo ucwords($data['city']) ?>" id="city"  placeholder="city" class="form-control"><br>
                                    <p style="color:red;" id="city_errors"></p>
                            </div>
                            <div class="col">
                                <input required type="text" name="othernames" value="<?php echo ucwords($data['othernames']) ?>" id="othernames"  placeholder="Other Names" class="form-control">
                                ...
                                <input required type="text" name="address" value="<?php echo ucwords($data['address']) ?>" id="address"  placeholder="Residential Address" class="form-control">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
	        <button type="submit" class="btn-primary btn" name="editInfo" >Submit</button>
	      </div>
	      </form>
	    </div>
	  </div>
...
<!-- 
	...
	<div class="modal fade" id="editInfo" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="staticBackdropLabel">Submit Application form</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	      	<h6>Submit the already filled application form including the required attached files </h6>
	      	<form method="post" enctype="multipart/form-data">
				<div>
					<div class="col-lg-12 col-md-12 col-12 mb-2">
						<label>File(pdf)<span>*</span></label>
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
	        <button class="btn-primary btn" name="uploadApplication">Submit</button>
	      </div>
	      </form>
	    </div>
	  </div>
